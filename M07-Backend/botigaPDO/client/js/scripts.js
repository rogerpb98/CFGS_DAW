...
async function showDetalle(id) {
  try {
      ...
      console.log(datos);
      let producto = '';
      producto += "<h2>"+datos.nombre+"</h2><p>"+datos.descripcion+"</p><p>Precio: "+datos.precio+"€</p><p>Vendedor: <span id='vendedor'>"+datos.client+"</span></p>";
      ...
      producto+="<br>";
      (document.getElementById("username").innerHTML == datos.client) ? producto+="<button onclick='eliminarProducto("+datos.id+")'>Eliminar producto</button><a href='modificar-producto.php?id="+datos.id+"'>Modificar producto</a>" : console.log("no") ;
...
async function eliminarProducto(id) {
  ...
  try {
    const response = await fetch("../api/producto/delete-product.php", {
      method: "DELETE",
      headers: {
          'Content-Type': 'application/json'
      },
...
async function modificarProducto(id) {
  ...
  try {
    const response = await fetch("../api/producto/update-product.php", {
      method: "POST",
      headers: {
          'Content-Type': 'application/json'
      },
