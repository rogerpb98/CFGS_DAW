...
public class TestExercise {
    ...
    @ParameterizedTest
    @CsvSource(value={
        "-2, 'hores fora de rang: -2', 'revisa quan hores és massa baix'",
    ...
    @ParameterizedTest
    @CsvSource(value={
        "-3, 'minuts fora de rang: -3', 'revisa quan minuts és massa baix'",
    ...
    @ParameterizedTest
    @CsvSource(value={
        "-4, 'segons fora de rang: -4', 'revisa quan segons és massa baix'",
